...
### Classroom: https://classroom.google.com/c/NzYwMzMxMTY0NzE4 code: tuy2lgn
...
* <h4> Grossman, I. Álgebra lineal. </h4>

* <h4> Poole, D. Álgebra lineal. Una introducción moderna. </h4>

* <h4> Kolman, B. Álgebra lineal. Fundamentos y aplicaciones </h4>
...
knitr::include_graphics('rotacion_2.png')
```
