...
@. Sea $V$ el espacio vectorial de polinomios con grado $\leq 2$. Verifique que las siguientes funciones definen un producto interno.

* a) $\left\langle f,g \right\rangle = \int_{-1}^1 f(t)g(t)dt$

* b) $\left\langle f, g \right\rangle =  f(1)g(1) + f'(1)g'(1)+f''(1)g''(1)$

* c) $\left\langle f,g \right\rangle = \sum_{i=1}^5 f(i)g(i)$

* d) $\left\langle f,g \right\rangle = \int_{-1}^1 f(t)g(t) + f'(t)g'(t)dt$
